...
class User6 {
  private static x = 10;   // 해당 글래서 안에서 User6.x 이렇게 사용해야 수정가능
  public static y = 20;  // 어디에서든 User6.y 해서 수정가능
  protected z = 30; // 익스텐스 한 클레스에서 수정가능
}
...
class User7 {
    ...
    static addOne(a:number){User7.x += a};
    static printX(){console.log(User7.x);
    }
  }
