...
//노이해
function counting<T extends string | string[]> (a: T) {
    console.log(a.length);
}

counting<string>('hello');
counting<string[]>(['kim','park']);
...
function trans<T> (a:string):T {
return JSON.parse(a)
}

console.log(trans<Animal>(data));
...
//   let a = new Person33 <string>('어쩌구'); // 왜 에러뜨는거야 시발
//   a.name //any 타입이 되었넹 
